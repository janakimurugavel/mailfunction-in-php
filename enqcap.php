...
if(isset($_SESSION['enq_captcha']))
{
unset($_SESSION['enq_captcha']); // destroy the session if already there
}
...
$_SESSION['enq_captcha'] =$random_text; // Assign the random text to session variable
