...
if(isset($_SESSION['car_captcha']))
{
unset($_SESSION['car_captcha']); // destroy the session if already there
}
...
$_SESSION['car_captcha'] =$random_text; // Assign the random text to session variable
